...
(function () {
  ...
  function buildBookmarklet() {
    ...
    var code = [
      ...
      '    var sc=document.createElement("blockquote");sc.id="ai-summary-inline";sc.style.cssText="border-left:4px solid #007bff;padding:15px;margin:20px 0;background:rgba(0,123,255,0.05);";sc.innerHTML="<div><h2 style=\\"margin-top:0\\">AI Summary 🧙</h2>"+summary+"</div>";sc.appendChild(buildActions());targetEl.insertAdjacentElement("beforebegin",sc);',
      '  }else{',
