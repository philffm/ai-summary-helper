...
<h1 style="display: flex; align-content: center; align-items: center; gap: 12px;"><img src="chrome-extension/icons/icon128.png" style="width:48px; height:48px">AI Summary Helper</h1>
